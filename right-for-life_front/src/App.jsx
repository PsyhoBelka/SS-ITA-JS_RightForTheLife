...
// todo: save scroll when returning with the Back button and raise scroll to the top when opening a new component
// todo: open and close page animations
function App({ store }) {
	return (
				...
				<Header />
					<SiteContentContainer>
						<Switch>
							...
							<Route exact path="/emergencyPet" render={props => <AnimalDetailsPage emergency={true} {...props}/>} />
